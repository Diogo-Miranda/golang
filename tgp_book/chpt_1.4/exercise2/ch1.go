/*
Exercise 1.6: Modify the Lissajous 
program to produce images in multiple 
...
var palette = []color.Color{
    color.White,                   // fundo
    color.RGBA{R: 255, A: 255},   // vermelho
    color.RGBA{G: 255, A: 255},   // verde
    color.RGBA{B: 255, A: 255},   // azul
    color.Black,                  // preto
}
const (
